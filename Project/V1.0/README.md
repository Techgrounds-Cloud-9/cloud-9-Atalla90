...
G) A VPC peering connects both VPC's together, with the CIDR-blocks of only the two subnets where the servers reside registered in each other's route tables.  
